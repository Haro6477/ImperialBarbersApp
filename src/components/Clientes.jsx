...
export const Clientes = () => {
    ...
    const validar = () => {
        if (nombre.trim() === '') {
            ...
            if (operacion === 1) {
                addCliente(nombre, telefono, pts, genero, fechaNacimiento, codigoQR)
            } else {
                updateCliente(nombre, telefono, pts, genero, fechaNacimiento, codigoQR, id)
            }
                                ...
                                <tbody className='table-group-divider'>
                                    {clientes.map((cliente, i) => (
                                        <tr key={cliente.id}>
                                            ...
                                            <td>
                                                <button className='btn btn-warning' data-bs-toggle='modal' data-bs-target='#modalClientes'
